...
- `.kilocode/skills/ddd-practices/SKILL.md`
- `.kilocode/skills/ddd-practices/references/SOURCE-MAP.md`
...
- write each child directly under `.kilocode/skills/<prefix>-<child-scope>/`
...
- no writes to the current agent `.kilocode/skills`
...
- save to `.kilocode/skills/platform-operator/`
...
- confirm the resolved target path would stay under the resolved output root (`.kilocode/skills` by default, or `--path` when present)

...
```bash
python3 .kilocode/skills/aif-distillation/scripts/material-prep.py <source...>
```
...
```bash
python3 .kilocode/skills/aif-distillation/scripts/material-prep.py --cleanup <temp-dir>
```

<div class="w-full overflow-x-hidden relative" x-data="{ openMenu: false }">
    ...
    <section
        class="relative w-full min-h-[420px] sm:min-h-[440px] pt-[52px] pb-[22px] sm:pb-[22px] lg:pb-[22px] overflow-hidden">
        <div class="container">
            ...
            <div class="flex items-start lg:items-center justify-between">
                ...
                <div class="relative z-10 flex-1 flex flex-col gap-6">
                    ...
                    {{-- Заголовок --}}
                    <h1
                        class="text-white font-dela text-[20px] xs:text-[28px] sm:text-[32px] md:text-[36px] lg:text-[44px] xl:text-[40px] leading-none hidden md:block">
                        {{ __('livewire_index_main_hero_title') }}
                    </h1>
                    {{-- Описание --}}
                    ...
                    <div class="mt-6 flex flex-col gap-5 w-fit hidden sm:flex">
                        <div class="relative group">
                            <a href="{{ route('login') }}"
                                ...
                                <span
                                    class="pointer-events-none absolute left-0 top-0 w-full h-full z-0 flex items-center">
                                    <svg width="66" height="64" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_201_30" x1="18.979" y1="32"
                                                x2="47.1687" y2="45.3862" gradientUnits="userSpaceOnUse">
                                ...
                                <span
                                    class="relative text-[#17162D] z-10">{{ __('livewire_index_main_cta_button') }}</span>
                            </a>
                        </div>
                        {{-- Рейтинг --}}
                ...
                <div
                    class="relative mr-[-20px] sm:mr-0 flex-1 flex min-h-[178px] max-h-[178px] min-w-[204px] max-w-[204px] sm:max-w-[240px] md:max-w-[300px] lg:max-w-[414px] xl:max-w-[414px] sm:max-h-[210px] md:max-h-[262px] lg:min-h-[362px] xl:min-h-[362px] lg:max-h-[362px] xl:max-h-[362px] items-center justify-center z-0">
                    {{-- Основная зелёная стрелка --}}
                    <img src="{{ vite()->icon('/main/arrow-hero.svg') }}" alt="arrow"
                        class="relative z-10 select-none pointer-events-none max-w-[133px] md:max-w-none top-[-15px] md:top-0" />
                    <div id="comets-block"
                        class="absolute inset-0 pointer-events-none select-none z-0 overflow-visible"></div>
                </div>
            </div>
            {{-- Кнопка + рейтинг --}}
                    ...
                    <a href="{{ route('login') }}"
                        ...
                        <span class="pointer-events-none absolute left-0 top-0 w-full h-full z-0 flex items-center">
                            <svg width="66" height="64" fill="none" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_201_31" x1="18.979" y1="32"
                                        x2="47.1687" y2="45.3862" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#B4FF59" />
                                        <stop offset="0.5" stop-color="#FFFFFF" />
                                        <stop offset="1" stop-color="#B4FF59" />
            ...
            <div class="flex flex-col lg:flex-col items-start justify-between overflow-visible">
                ...
                <div class="flex items-center justify-between overflow-visible gap-[50px] sm:gap-[112px] pb-[20px]">
                    <div class="w-full max-w-[clamp(320px,80vw,747px)] xl:max-w-none">
                        <h2
                            class="text-white font-dela text-[20px] sm:text-[24px] xs:text-[28px] md:text-[32px] sm:leading-none leading-tight mb-6">
                    ...
                    <div x-data="clubCard"
                        class="relative cursor-pointer flex justify-center items-center mt-[10px] lg:mt-[100px] overflow-visible"
                        @click="window.location.href = '{{ route('login') }}'">
                        <img src="{{ vite()->icon('/main/glow-cards.svg') }}"
                        ...
                        <div
                            ...
                            <img src="{{ vite()->icon('/main/card-back.svg') }}"
                                class="absolute
                            ...
                            <div class="absolute left-0 top-0 z-10">
                                <template x-if="loggedIn && user.first && user.last">
                                    <img src="{{ vite()->icon('/main/card-golden-logged.svg') }}"
                                        class="w-full h-full pointer-events-none select-none backdrop-blur-lg rounded-[13px]"
                                        alt="front-side-card-logged" />
                                </template>
                                <template x-if="!loggedIn || !user.first || !user.last">
                                    <img src="{{ vite()->icon('/main/card-golden.svg') }}"
                                        class="w-full h-full pointer-events-none select-none backdrop-blur-lg rounded-[13px]"
                                        alt="front-side-card" />
                                </template>
                                <template x-if="loggedIn">
                                    <div
                                        class="absolute left-[10px] bottom-[10px] lg:left-[18px] lg:bottom-[19px] w-full flex font-ocr">
                                        <span
                                            class="inline-block rounded-[3px] lg:rounded-[6px] bg-[#FDE917] px-[3px] py-[1px] lg:px-[6px] lg:py-[2px] text-[7px] lg:text-[10px] tracking-wider">
                                            <template x-if="user.first && user.last">
                                                <span class="text-[#B26E00]"
                                                    x-text="$store.helpers.translit(user.first) + ' ' + $store.helpers.translit(user.last)"></span>
                                            </template>
                                        </span>
                                    </div>
                                </template>
                ...
                <div class="flex flex-col lg:flex-row gap-7">
                    {{-- Первая карточка --}}
                    <x-index.perspective-panel class="flex flex-col flex-1 rounded-[18px]"
                        gradient-class="w-[200px] h-[200px] blur-[200px] bg-[#7000FF]">
                        <div
                            class="relative bg-[#211F41] rounded-[18px] border-[2px] border-[#32247d] sm:px-[24px] sm:py-[16px] px-[16px] py-[16px]
                            ...
                            <ol
                                class="space-y-4 relative z-10 pb-[20px] max-w-none lg:max-w-[90%]  text-[14px] sm:text-[16px]">
                    ...
                    <x-index.perspective-panel class="flex flex-col flex-1 rounded-[18px]"
                        ...
                        text-white pointer-events-none">
                            ...
                            <ol
                                class="space-y-4 max-w-none lg:max-w-[90%] relative pb-[20px] z-10 text-[14px] sm:text-[16px]">
                                <li class="flex items-start gap-3">
                                    <span class="text-[16px] sm:text-[20px] font-black mt-[-2px]">1.</span>
                                    <span>
                                ...
                                <li class="flex items-start gap-3">
                                    <span class="text-[16px] sm:text-[20px] font-black mt-[-2px]">4.</span>
                                    <span>
                                        {{ __('livewire_index_main_crypto_step_4') }}
                                    </span>
                                </li>
                            </ol>
                            {{-- Иконка снизу справа --}}
            ...
            <div class="relative mx-auto">
                ...
                <div class="relative rounded-[22px] overflow-hidden bg-[#211F41]">
                    ...
                    <ol class="relative z-10 text-[18px] md:text-[20px]">
                        <li
                            class="sm:px-[20px] sm:py-[20px] px-[16px] py-[16px] rounded-t-[22px] border-[2px] border-[#32247d]">
                            <div class="flex items-center gap-[10px] sm:gap-[10px]">
                                <img src="{{ vite()->icon('/main/coin.png') }}" class="h-[64px]" alt="coin" />
                                <div class="flex flex-col">
                                    <span
                                        class="font-extrabold text-white sm:text-[20px] text-[16px] leading-tight pb-[4px] lg:pb-[1px]">
                                        {{ __('livewire_index_main_benefit_1_title') }}
                                    </span>
                                    <span
                                        class="text-[#887AA4] font-semibold text-[14px] sm:text-[16px] leading-tight">
                        ...
                        <li
                            class="sm:px-[20px] sm:py-[20px] px-[16px] py-[16px] border-[2px] [border-image:linear-gradient(180deg,#2E1D78,#433F8E)_1]">
                            <div class="flex items-center gap-[10px] sm:gap-[10px]">
                                <img src="{{ vite()->icon('/main/key.png') }}" class="h-[64px]" alt="coin" />
                                <div class="flex flex-col">
                                    <span
                                        class="font-extrabold text-white sm:text-[20px] text-[16px] leading-tight pb-[4px] lg:pb-[1px]">
                        ...
                        <li
                            class="sm:px-[20px] sm:py-[20px] px-[16px] py-[16px] border-[2px] [border-image:linear-gradient(180deg,#2E1D78,#433F8E)_1]">
                            <div class="flex items-center gap-[10px] sm:gap-[10px]">
                                <img src="{{ vite()->icon('/main/book.png') }}" class="h-[64px]" alt="coin" />
                                <div class="flex flex-col">
                                    <span
                                        class="font-extrabold text-white sm:text-[20px] text-[16px] leading-tight pb-[4px] lg:pb-[1px]">
                        ...
                        <li
                            class="sm:px-[20px] sm:py-[20px] px-[16px] py-[16px] border-[2px] [border-image:linear-gradient(180deg,#2E1D78,#433F8E)_1]">
                            <div class="flex items-center gap-[10px] sm:gap-[10px]">
                                <img src="{{ vite()->icon('/main/book-statue.png') }}" class="h-[64px]"
                                    alt="coin" />
                                <div class="flex flex-col">
                                    <span
                                        class="font-extrabold text-white sm:text-[20px] text-[16px] leading-tight pb-[4px] lg:pb-[1px]">
                        ...
                        <li
                            class="sm:px-[20px] sm:py-[20px] px-[16px] py-[16px] rounded-b-[22px] border-[2px] border-[#32247d]">
                            <div class="flex items-center gap-[10px] sm:gap-[10px]">
                                <img src="{{ vite()->icon('/main/cup.png') }}" class="h-[64px]" alt="coin" />
                                <div class="flex flex-col">
                                    <span
                                        class="font-extrabold text-white sm:text-[20px] text-[16px] pb-[4px] lg:pb-[2px]">
                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between mt-8 pr-2">
                    ...
                    <a href="{{ route('login') }}"
                        class="relative flex items-center px-[16px] py-[16px] sm:px-[32px] sm:py-[20px] rounded-[8px] bg-[#B4FF59] text-black font-semibold text-[18px] transition-shadow duration-300 ease-in hover:bg-[#C5FF80] hover:shadow-[0_0_16px_0_#B4FF59] focus:ring-2 focus:ring-[#B4FF59] group overflow-hidden">
                        {{-- SVG-блик (как картинка), под текстом --}}
                        <span class="pointer-events-none absolute left-0 top-0 w-full h-full z-0 flex items-center">
                            <svg width="66" height="64" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="animate-shine-sweep will-change-transform" viewBox="0 0 66 64">
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_201_32" x1="18.979" y1="32"
                                        x2="47.1687" y2="45.3862" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#B4FF59" />
                                        <stop offset="0.5" stop-color="#FFFFFF" />
                                        <stop offset="1" stop-color="#B4FF59" />
            ...
            <div class="relative mx-auto">
                ...
                <div class="flex flex-col gap-7">
                    ...
                    <div class="flex flex-col md:flex-row gap-7">
                        ...
                        <div
                            class="flex-1 relative min-h-[369px] lg:min-h-0 rounded-[22px] border-[2px] border-[#3b3571] bg-[radial-gradient(ellipse_50%_100%_at_90%_90%,_#4D2A88_0%,_#232148_40%,_#211F41_100%)] px-4 lg:py-[20px] lg:px-8 py-[20px] lg:pr-[260px] min-h-[200px] mb-2 overflow-hidden">
                            <!-- SVG-иконка справа -->
                            <img src="{{ vite()->icon('/main/income-gen.svg') }}"
                                ...
                                alt="income" />
                            <!-- Контент -->
                            <div class="relative z-10 lg:max-w-[100%] leading-tight">
                                <div class="text-white text-[16px] lg:text-[20px] mb-[20px] font-extrabold">
                                    {{ __('livewire_index_main_income_staking_title') }}
                                </div>
                                <div class="text-[#887AA4] text-[16px] mb-[12px] font-semibold leading-tight">
                                    {{ __('livewire_index_main_income_staking_desc') }}
                                </div>
                                <div class="mb-[12px] text-[16px] flex flex-col">
                                    ...
                                    <span class="text-[#887AA4] font-semibold">
                                        {{ __('livewire_index_main_income_staking_yield') }}
                                    </span>
                                </div>
                                <div class="mb-[43px] text-[16px] flex flex-col">
                                    <span class="underline text-white font-extrabold pb-[6px]">
                                        {{ __('livewire_index_main_income_staking_full_automatic') }}
                                    </span>
                                    <span class="text-[#887AA4] font-semibold leading-none">
                                        {!! __('livewire_index_main_income_staking_auto') !!}
                                    </span>
                                </div>
                            </div>
                            <div
                                class="absolute right-[16px] bottom-[14px] lg:right-[32px] lg:bottom-[24px] flex flex-col items-center z-10">
                                <div class="flex flex-col items-end">
                                    <span
                                        class="text-white text-[24px] lg:text-[24px] font-dela leading-none">$100</span>
                                    <span
                                        class="text-[#887AA4] text-[12px] lg:text-[16px] mb-[8px] lg:mb-3 font-semibold">
                        ...
                        <div
                            ...
                            <img src="{{ vite()->icon('/main/income-gen.svg') }}"
                                ...
                                alt="income" />
                            <!-- Контент -->
                            <div class="relative z-10 lg:max-w-[414px] leading-tight">
                                <div class="text-white text-[16px] lg:text-[20px] mb-[20px] font-extrabold">
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-end">
                                    <span
                                        class="text-white text-[24px] lg:text-[24px] font-dela leading-none">$1000</span>
                                    <span
                                        class="text-[#887AA4] text-[12px] lg:text-[16px] mb-[8px] lg:mb-3 font-semibold">
                                        {{ __('livewire_index_main_income_start_sum') }}
                                    </span>
                    ...
                    <div class="flex flex-col md:flex-row gap-7">
                        ...
                        <div
                            class="relative min-h-[441px] lg:min-h-0 flex-1 rounded-[22px] border-[2px] border-[#3b3571] bg-[radial-gradient(ellipse_100%_100%_at_85%_85%,_#4D2A88_0%,_#232148_40%,_#211F41_100%)] px-4 lg:py-[20px] lg:px-8 py-[20px] min-h-[200px] overflow-hidden">
                            <img src="{{ vite()->icon('/main/trust-manage.svg') }}"
                                class="absolute left-[-26px] bottom-[-13px] lg:left-unset lg:right-[-12px] lg:top-[-2px] z-0 pointer-events-none select-none"
                                alt="trust" />
                            <div class="relative z-10 leading-tight max-w-[414px]">
                                <div
                                    class="text-white text-[16px] lg:text-[20px] mb-[20px] font-extrabold leading-none">
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-end">
                                    <span
                                        class="text-white text-[24px] lg:text-[24px] font-dela leading-none">$30,000</span>
                                    <span
                                        class="text-[#887AA4] text-[12px] lg:text-[16px] mb-[8px] lg:mb-3 font-semibold">
                                        {{ __('livewire_index_main_income_start_sum') }}
                                    </span>
                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="flex flex-col mb-2 lg:max-w-[65%]">
                                    ...
                                    <span
                                        class="text-[#887AA4] font-semibold leading-none">{{ __('livewire_index_main_multivector_flexibility') }}</span>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-end">
                                    <span
                                        class="text-white text-[24px] lg:text-[24px] font-dela leading-none">$50,000</span>
                                    <span
                                        class="text-[#887AA4] text-[12px] lg:text-[16px] mb-[8px] lg:mb-3 font-semibold">
                                        {{ __('livewire_index_main_income_start_sum') }}
                                    </span>
        ...
        <div class="container">
            <div class="relative mx-auto flex flex-col lg:flex-col gap-10">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex lg:flex-row flex-col justify-between lg:mb-10">
                        <div class="flex flex-col mb-[20px] lg:mb-0">
                            ...
                            <div
                                class="text-white font-extrabold text-[16px] lg:text-[20px] mb-[20px] lg:mb-8 leading-tight">
                                {{ __('livewire_index_main_academy_subtitle') }}
                            </div>
                            <div class="text-[#BDBDBD] text-[16px] max-w-[612px] leading-tight">
                                {{ __('livewire_index_main_academy_intro') }}
                            </div>
                        </div>
                        <div class="relative flex-1 lg:w-[516px] lg:h-[382px]">
                    ...
                    <div class="flex flex-col mt-[20px] lg:mt-0 gap-7">
                        <!-- Курс 1 -->
                        <div
                            class="relative min-h-[531px] lg:min-h-0 rounded-[22px] border-[2px] border-[#33267E] bg-[radial-gradient(ellipse_75%_100%_at_90%_90%,_#4D2A88_0%,_#232148_50%,_#211F41_100%)] pt-[20px] lg:pt-[30px] px-4 lg:px-[34px] lg:px-8 py-8 overflow-hidden">
                            <img src="{{ vite()->icon('/main/verified-check.svg') }}"
                            ...
                            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center">
                                <div class="flex text-[16px] flex-col lg:max-w-[60%] min-w-0 gap-2">
                                    <div
                                        class="text-white text-[16px] lg:text-[20px] mb-[12px] font-extrabold leading-none">
                                        {{ __('livewire_index_main_course_1_title') }}
                                    </div>
                                    <div>
                                        <div
                                            class="text-white underline underline-offset-[4px] font-extrabold pb-[4px]">
                                            {{ __('availability') }}</div>
                                    ...
                                    <div>
                                        <div
                                            class="text-white underline underline-offset-[3px] font-extrabold pb-[4px]">
                            ...
                            <div
                                class="absolute right-[14px] bottom-[14px] lg:right-[32px] lg:bottom-[32px] flex flex-col items-end">
                                <div class="py-4 text-right text-[12px] lg:text-[16px]">
                                    ...
                                    <div class="text-white font-extrabold underline">
                                        {{ __('livewire_index_main_practical_free') }}</div>
                                </div>
                                <button @click="window.open('https://t.me/ITCAPITALTOP', '_blank')"
                                    class="relative flex items-center justify-center bg-[#B4FF59] text-black rounded-[8px] font-semibold text-[14px] lg:text-[16px] px-4 py-[12px] transition-shadow duration-300 ease-in hover:bg-[#C5FF80] group overflow-hidden">
                        ...
                        <!-- Курс 2 -->
                        <div
                            class="relative min-h-[510px] lg:min-h-0 rounded-[22px] border-[2px] border-[#33267E] bg-[radial-gradient(ellipse_75%_100%_at_90%_90%,_#4D2A88_0%,_#232148_50%,_#211F41_100%)] pt-[20px] lg:pt-[30px] px-4 lg:px-[34px] lg:px-8 py-8 overflow-hidden">
                            <img src="{{ vite()->icon('/main/verified-check.svg') }}"
                        ...
                        <!-- Курс 3 -->
                        <div
                            class="relative min-h-[530px] lg:min-h-0 rounded-[22px] border-[2px] border-[#33267E] bg-[radial-gradient(ellipse_75%_100%_at_90%_90%,_#4D2A88_0%,_#232148_50%,_#211F41_100%)] pt-[20px] lg:pt-[30px] px-4 lg:px-[34px] lg:px-8 py-8 overflow-hidden">
                            <img src="{{ vite()->icon('/main/verified-check.svg') }}"
                                class="absolute left-[16px] bottom-[16px] top-unset lg:left-unset lg:right-6 lg:top-5 z-10"
                                alt="check" />
                    ...
                    <div class="flex flex-col items-start lg:items-end lg:flex-row justify-between gap-[30px]">
                        <div class="mt-10">
                            ...
                            <ul
                                class="list-none flex flex-col text-[#BDBDBD] text-[16px] space-y-1 gap-2 leading-tight">
                                <li class="flex items-start gap-2">
                                    <img src="{{ vite()->icon('/main/check-mark.png') }}" class="w-[24px] h-[24px]"
                                        alt="" />
                                    <span>
                        ...
                        <div class="flex items-end">
                            <button @click="window.open('https://t.me/ITCAPITALTOP', '_blank')"
                                ...
                                <span
                                    class="pointer-events-none absolute left-0 top-0 w-full h-full z-0 flex items-center">
                                    <img src="{{ vite()->icon('/main/glare.svg') }}" alt=""
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const onScroll = () => {
                ...
                if (translate.y + parentStick.querySelector('.must-stick').clientHeight > parentStick
                    .clientHeight) {
                    translate.y = parentStick.clientHeight - parentStick.querySelector('.must-stick')
                        .clientHeight
                    window.removeEventListener('scroll', onScroll)
                }
            }
...
<script>
    function randomComet() {
        const sizes = window.innerWidth <= 450 ? [16, 20, 24] // для мобильных
            :

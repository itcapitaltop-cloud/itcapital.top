            ...
            <x-slot name="partners">
                <div class="relative">
                    ...
                    <div class="text-white mb-[22px] flex items-center gap-[12px]">
                        <span
                            class="font-dela text-[20px] h-[23px] leading-none">{{ __('livewire_partners_rank') }}</span>
                        <span
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex gap-3">
                                ...
                                <button
                                    ...
                                    <img src="{{ vite()->icon('actions/copy-new.svg') }}" class="w-4 h-4"
                                        alt="">
                    ...
                    <div class="flex mb-[32px] flex-col md:flex-row md:flex-wrap gap-8">
                        <div class="flex-none bg-white/5 rounded-[24px] p-8 space-y-6 border border-white/10">
                            ...
                            <div class="space-y-3">
                                ...
                                <x-ui.button :disabled="$partnerBalance <= 0" wire:click="openPackageModal"
                                    wire:target="openPackageModal" wire:loading.attr="disabled" class="flex w-auto">
                                    ...
                                    <img src="{{ vite()->icon('/advantages/store.svg') }}" class="pl-[5px]"
                                        alt="">
                                </x-ui.button>
                            </div>
                        </div>
                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class=" font-dela text-[16xp] leading-[40px]">
                                    ...
                                    @endif
                                    <th class="py-1.5 pr-4 font-medium">{{ __('livewire_partners_table_telegram') }}
                                    </th>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody>
                            ...
                            <x-ui.feed-loader :has-more="$logHasMore" :colspan="4" :page="$feedPerPage" />
                        </tbody>
                    </table>
                </div>
            </x-slot>
            ...
            <form wire:submit.prevent="sendToPartner" class="space-y-10 w-[320px] md:w-[350px]">
                ...
                <div class="flex items-center gap-2 text-[16px]">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span
                            class="font-extrabold text-white">{{ number_format($partnerBalance, 0, ',', '') }}</span>
                    </div>
                </div>
        ...
        <div class="absolute inset-0 z-[1000] flex items-center justify-center overflow-hidden">
            <div class="protected-sections">
                ...
                <a href="{{ route('finance') }}"
                    class="block w-[137px] rounded-lg bg-[var(--color-button-success)] py-2 px-2 text-center text-[rgba(23,22,45,1)] text-base font-medium">

<div x-data="{ isModalSentToPartner: false }">
    <x-ui.card-tabs
        ...
        <x-slot name="partners">
            <div class="relative">
                <a href="{{ Storage::disk('public')->url('docs/how-works-partners-program.pdf') }}"
                ...
                <div class="text-white mb-[22px] flex items-center gap-[12px]">
                    ...
                    <span class="flex text-[24px] items-center justify-center
                ...
                <div class="flex mb-[32px] flex-col md:flex-row md:flex-wrap gap-8">
                    <div class="flex-none bg-white/5 rounded-[24px] p-8 space-y-6 border border-white/10">
                        <div class="font-dela text-[20px] text-white leading-none">{{ __('livewire_partners_partner_balance_title') }}</div>
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-end">
                            <div class="flex flex-col items-start mb-[10px] md:mb-0">
                                ...
                                <span class="text-white/40 pl-[16px] text-[12px] font-semibold">{{ __('livewire_partners_partner_balance_label') }}</span>
                            </div>
                            <div class="flex gap-[30px] items-end">
                                <div class="flex flex-col items-start">
                                    ...
                                    <span class="text-white/40 font-semibold text-[12px] mt-[3px] pl-[13px]">{{ __('livewire_partners_for_week') }}</span>
                                </div>
                                ...
                                <div class="flex flex-col items-start">
                                    ...
                                    <span class="text-white/40 font-semibold text-[12px] mt-[3px] pl-[13px]">{{ __('livewire_partners_for_month') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="inline-flex flex-col w-auto md:flex-row gap-3">
                                <x-ui.button wire:click="sendToMainSelf"
                                             :disabled="$partnerBalance <= 0"
                                             class="inline-flex w-auto self-start">
                                    {{ __('livewire_partners_to_main_balance') }}
                                    <img src="{{ vite()->icon('/advantages/arrow-across.svg') }}" class="pl-[5px]" alt="">
                                </x-ui.button>
                                <x-ui.button x-on:click="isModalSentToPartner = true"
                                             :disabled="$partnerBalance <= 0"
                                             class="inline-flex w-auto self-start">
                                    {{ __('livewire_partners_to_partner') }}
                                    <img src="{{ vite()->icon('/advantages/arrow-right.svg') }}" class="pl-[5px]" alt="">
                                </x-ui.button>
                            </div>
                            <x-ui.button
                                         :disabled="$partnerBalance <= 0"
                                         wire:click="openPackageModal"
                                         wire:target="openPackageModal"
                    ...
                    <div class="flex-none bg-white/5 rounded-[24px] p-8 space-y-6 border border-white/10">
                        <div class="font-dela text-[20px] text-white leading-none">{{ __('livewire_partners_regular_bonus_title') }}</div>
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-end">
                            <div class="flex flex-col items-start mb-[10px] md:mb-0">
                                <div class="flex items-center gap-1">
                                    <img src="{{ vite()->icon('/currency/itc-partners.svg') }}" alt="">
                            ...
                            <div class="flex gap-[30px] items-end">
                                <div class="flex flex-col items-start">
                                    ...
                                    <span class="text-white/40 font-semibold text-[12px] mt-[3px] pl-[13px]">{{ __('livewire_partners_total_ever') }}</span>
                                </div>
                                <div class="flex flex-col items-start">
                                    <div class="flex items-center gap-1">
                                        <span class="text-white/60 text-[16px] font-bold leading-none">+</span>
    ...
    <x-widget.modal class="p-6" condition-name="isModalSentToPartner" maxWidth="md">
        <form wire:submit.prevent="sendToPartner" class="space-y-10 w-[320px] md:w-[350px]">
            ...
            <x-ui.input name="toPartnerAmount" placeholder="{{ __('livewire_partners_modal_enter_amount') }}" validate="number" input-class="py-[5px] px-[12px]">
    ...
    <x-account.partners.to-package-modal

...
<div {{ $attributes->merge(['class'=>'flex rounded-[12px] bg-[#211F41] px-6 py-4 gap-4']) }}>
    {{-- item --}}
    <div class="pr-4 flex flex-col">
        ...
        <p class="text-[10px] text-white/40 leading-[0.5]">{{ __('components_account_dashboard_widget_balance_pill_main') }}</p>
    </div>

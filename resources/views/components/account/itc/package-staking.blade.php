            ...
            <div class="relative h-full flex flex-col justify-between p-4 sm:p-6 text-white">
                ...
                <div class="flex items-end gap-3 sm:gap-5">
                    <div class="flex flex-col gap-1 sm:gap-2">
                        <span
                            class="uppercase text-white tracking-wide text-[8px] sm:text-[10px] font-normal opacity-50">
                            {{ $package->uuid }}
                        </span>
    ...
    <div class="flex flex-col gap-4 sm:gap-6 text-white w-full lg:w-[400px]">
        <div class="flex justify-between items-center">
            <span class="text-white/70 text-sm sm:text-base">
                {{ __('component_livewire_account_itc_staking_statistic_to_moth') }}
            </span>
        ...
        <div class="flex justify-between items-center">
            <span class="text-white/70 text-sm sm:text-base">
                {{ __('component_livewire_account_itc_staking_statistic_last_moth') }}
            </span>
            <div class="flex items-baseline gap-1">
        ...
        <div class="flex justify-between items-center">
            <span class="text-white/70 text-sm sm:text-base">
                {{ __('component_livewire_account_itc_staking_statistic_general') }}
            </span>
            <div class="flex items-baseline gap-1">
                <img src="{{ vite()->icon('/currency/itc-staking.svg') }}" class="w-3 sm:w-4" alt="ITC">

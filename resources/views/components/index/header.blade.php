        ...
        <div class="flex justify-between items-center">
            ...
            @unless ($isAuthPage)
                <ul class="gap-[36px] hidden xl:flex">
                    <li>
                        <a href="{{ url('/') }}#club"
                            class="text-white font-medium transition-colors duration-200 hover:text-[#B4FF59]">
                            {{ __('about_club') }}
                        </a>
                    </li>
                    <li>
            ...
            <button type="button" @click="$store.menu.open = true"
                class="flex md:hidden items-center justify-center ml-2" aria-label="{{ __('open_menu') }}">
    ...
    <script>
        Alpine.store('helpers', {
            translit(str) {
                ...
                const en = ['A', 'B', 'V', 'G', 'D', 'E', 'E', 'ZH', 'Z', 'I', 'Y', 'K', 'L', 'M', 'N', 'O', 'P',

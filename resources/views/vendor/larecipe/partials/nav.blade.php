<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        <div class="flex items-center flex-no-shrink">
            <a href="{{ url('/itcapitalmoonshineadminpanel') }}" class="flex items-center flex-no-shrink text-black mx-4">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/itcapitaltop-cloud/itcapital.top" target="__blank" type="black" class="mx-2 px-4">

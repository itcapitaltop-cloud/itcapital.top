@php $buttonColor = '#B4FF59'; @endphp
    <!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="UTF-8">
    <title>{{ __('email_subject') }}</title>
</head>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" style="padding:32px 0;background:#17162d;">
            <img src="{{ vite()->icon('/main/logotype.png') }}" width="180" alt="Logo" style="display:block;">
        </td>
    </tr>

...
return [
    ...
    'business' => [
        ...
        'deposit_amount_changed_by_admin' => 'Администратор изменил сумму заявки на ввод с :old_amount ITC на :amount ITC. Баланс не изменён',
        'withdraw_amount_increased_by_admin' => 'Администратор увеличил сумму заявки на вывод. С баланса дополнительно списано :amount ITC',
        'withdraw_amount_decreased_by_admin' => 'Администратор уменьшил сумму заявки на вывод. На баланс возвращено :amount ITC',
